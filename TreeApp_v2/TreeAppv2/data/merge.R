df1 = readRDS("data_1995.rds")
df2 = readRDS("data_2005.rds")
df3 = readRDS("data_2015.rds")
...
tmp1<- df1[,c("RecordId","tree_dbh","status","Address","Zip_New","zip_city","state","Borough","longtude","latitude","Spc_Common","NTA_2010","Condition","Year")]
